                          ...
                          <tr key={r.id} className="border-b-2 border-black hover:bg-yellow-50 transition-colors whitespace-nowrap font-bold text-center">
                            ...
                            <td className="p-3 border-r-2 border-black bg-white">
                              <div className="flex items-center justify-center gap-1">
                                ...
                                {r.reminderThreeDaysBeforeSent && <CheckCircle2 className="w-4 h-4 text-green-500 shrink-0" title="已發送" />}
                              </div>
                            </td>
                            <td className="p-3 border-r-2 border-black bg-white">
                              <div className="flex items-center justify-center gap-1">
                                <span>{getSubDays(r.date, 2)}</span>
                                {r.reminderTwoDaysBeforeSent && <CheckCircle2 className="w-4 h-4 text-green-500 shrink-0" title="已發送" />}
                              </div>
                            </td>
                            <td className="p-3 border-r-2 border-black bg-white">
                              <div className="flex items-center justify-center gap-1">
                                <span>{getSubDays(r.date, 1)}</span>
                                {r.reminderDayBeforeSent && <CheckCircle2 className="w-4 h-4 text-green-500 shrink-0" title="已發送" />}
                              </div>
                            </td>
                            <td className="p-3 bg-white">
                              <div className="flex items-center justify-center gap-1">
                                <span>{r.date}</span>
                                {r.reminderSameDaySent && <CheckCircle2 className="w-4 h-4 text-green-500 shrink-0" title="已發送" />}
                              </div>
                            </td>
                          </tr>
                        );
